...
*0.2.5*
- BREAKING CHANGES: As per Melpa standards, packages should neither automatically activate =add-advice= or a globalized minor mode. Starting in 0.2.5 you therefore need to add =(cuckoo-search-global-mode t)= to your configuration!
