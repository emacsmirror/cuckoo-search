...
*cuckoo-search* package uses [[https://github.com/BurntSushi/ripgrep][ripgrep]]-magic to address this. It searches the content of all entries currently displayed for specific terms (regexp welcome). 
...
A cuckoo draws on other birds to hatch his eggs. This package uses some Elfeed-code and rg to create the search, hence the name.  
